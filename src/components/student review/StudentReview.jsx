            ...
            <div className="row justify-content-center">
                <div className="col-md-8">
                    <div className="student_review_header">
                        ...
                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tempore ex deserunt praesentium blanditiis velit voluptatem nihil accusantium temporibus eveniet, a voluptates, magnam, rem laborum cum doloribus quia? Quia, distinctio blanditiis!</p>
                    </div>
